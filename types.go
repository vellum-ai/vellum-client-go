...
type AdHocExpandMetaRequestRequest struct {
...
func (a *AdHocExpandMetaRequestRequest) GetExtraProperties() map[string]interface{} {
	return a.extraProperties
}

func (a *AdHocExpandMetaRequestRequest) UnmarshalJSON(data []byte) error {
	type unmarshaler AdHocExpandMetaRequestRequest
	var value unmarshaler
	if err := json.Unmarshal(data, &value); err != nil {
		return err
	}
	*a = AdHocExpandMetaRequestRequest(value)
...
func (a *AdHocExpandMetaRequestRequest) String() string {
	if len(a._rawJSON) > 0 {
...
const (
	...
	MlModelFeaturePromptCachingSupport             MlModelFeature = "PROMPT_CACHING_SUPPORT"
)
...
func NewMlModelFeatureFromString(s string) (MlModelFeature, error) {
	...
	case "PROMPT_CACHING_SUPPORT":
		return MlModelFeaturePromptCachingSupport, nil
	}
...
type OpenApiEnumProperty struct {
	Title       *string                        `json:"title,omitempty" url:"title,omitempty"`
	Description *string                        `json:"description,omitempty" url:"description,omitempty"`
	Enum        []*OpenApiEnumPropertyEnumItem `json:"enum" url:"enum"`
	Default     *OpenApiEnumPropertyDefault    `json:"default,omitempty" url:"default,omitempty"`
	type_       string
...
func (o *OpenApiEnumProperty) GetExtraProperties() map[string]interface{} {
	return o.extraProperties
}

func (o *OpenApiEnumProperty) Type() string {
	return o.type_
}

func (o *OpenApiEnumProperty) UnmarshalJSON(data []byte) error {
	type embed OpenApiEnumProperty
	var unmarshaler = struct {
		embed
		Type string `json:"type"`
	}{
	...
	*o = OpenApiEnumProperty(unmarshaler.embed)
	if unmarshaler.Type != "enum" {
		return fmt.Errorf("unexpected value for literal on type %T; expected %v got %v", o, "enum", unmarshaler.Type)
	}
	o.type_ = unmarshaler.Type
...
func (o *OpenApiEnumProperty) MarshalJSON() ([]byte, error) {
	type embed OpenApiEnumProperty
	var marshaler = struct {
		embed
		Type string `json:"type"`
...
func (o *OpenApiEnumProperty) String() string {
	if len(o._rawJSON) > 0 {
		if value, err := core.StringifyJSON(o._rawJSON); err == nil {
			return value
		}
...
type OpenApiEnumPropertyDefault struct {
	String  string
	Integer int
}

func (o *OpenApiEnumPropertyDefault) UnmarshalJSON(data []byte) error {
	var valueString string
	if err := json.Unmarshal(data, &valueString); err == nil {
	...
	if err := json.Unmarshal(data, &valueInteger); err == nil {
		o.Integer = valueInteger
		return nil
	}
	return fmt.Errorf("%s cannot be deserialized as a %T", data, o)
}

func (o OpenApiEnumPropertyDefault) MarshalJSON() ([]byte, error) {
	if o.String != "" {
...
type OpenApiEnumPropertyDefaultVisitor interface {
	VisitString(string) error
	VisitInteger(int) error
}

func (o *OpenApiEnumPropertyDefault) Accept(visitor OpenApiEnumPropertyDefaultVisitor) error {
	if o.String != "" {
...
type OpenApiEnumPropertyEnumItem struct {
	String  string
	Integer int
}

func (o *OpenApiEnumPropertyEnumItem) UnmarshalJSON(data []byte) error {
	var valueString string
	if err := json.Unmarshal(data, &valueString); err == nil {
		o.String = valueString
		return nil
...
func (o OpenApiEnumPropertyEnumItem) MarshalJSON() ([]byte, error) {
	if o.String != "" {
		return json.Marshal(o.String)
	}
	if o.Integer != 0 {
...
type OpenApiEnumPropertyEnumItemVisitor interface {
	VisitString(string) error
	VisitInteger(int) error
}

func (o *OpenApiEnumPropertyEnumItem) Accept(visitor OpenApiEnumPropertyEnumItemVisitor) error {
	if o.String != "" {
		return visitor.VisitString(o.String)
	}
	if o.Integer != 0 {
...
// An OpenAPI specification of a property with type 'enum'
type OpenApiEnumPropertyRequest struct {
	Title       *string                               `json:"title,omitempty" url:"title,omitempty"`
	Description *string                               `json:"description,omitempty" url:"description,omitempty"`
	Enum        []*OpenApiEnumPropertyRequestEnumItem `json:"enum" url:"enum"`
	Default     *OpenApiEnumPropertyRequestDefault    `json:"default,omitempty" url:"default,omitempty"`
	type_       string
...
func (o *OpenApiEnumPropertyRequest) GetExtraProperties() map[string]interface{} {
	return o.extraProperties
}

func (o *OpenApiEnumPropertyRequest) Type() string {
	return o.type_
}

func (o *OpenApiEnumPropertyRequest) UnmarshalJSON(data []byte) error {
	type embed OpenApiEnumPropertyRequest
	var unmarshaler = struct {
		embed
		Type string `json:"type"`
	}{
	...
	*o = OpenApiEnumPropertyRequest(unmarshaler.embed)
	if unmarshaler.Type != "enum" {
		return fmt.Errorf("unexpected value for literal on type %T; expected %v got %v", o, "enum", unmarshaler.Type)
	}
	o.type_ = unmarshaler.Type
...
func (o *OpenApiEnumPropertyRequest) MarshalJSON() ([]byte, error) {
	type embed OpenApiEnumPropertyRequest
	var marshaler = struct {
		embed
		Type string `json:"type"`
...
func (o *OpenApiEnumPropertyRequest) String() string {
	if len(o._rawJSON) > 0 {
		if value, err := core.StringifyJSON(o._rawJSON); err == nil {
			return value
		}
...
type OpenApiEnumPropertyRequestDefault struct {
	String  string
	Integer int
}

func (o *OpenApiEnumPropertyRequestDefault) UnmarshalJSON(data []byte) error {
	var valueString string
	if err := json.Unmarshal(data, &valueString); err == nil {
		o.String = valueString
		return nil
...
func (o OpenApiEnumPropertyRequestDefault) MarshalJSON() ([]byte, error) {
	if o.String != "" {
		return json.Marshal(o.String)
	}
	if o.Integer != 0 {
...
type OpenApiEnumPropertyRequestDefaultVisitor interface {
	VisitString(string) error
	VisitInteger(int) error
}

func (o *OpenApiEnumPropertyRequestDefault) Accept(visitor OpenApiEnumPropertyRequestDefaultVisitor) error {
	if o.String != "" {
		return visitor.VisitString(o.String)
	}
	if o.Integer != 0 {
...
type OpenApiEnumPropertyRequestEnumItem struct {
	String  string
	Integer int
}

func (o *OpenApiEnumPropertyRequestEnumItem) UnmarshalJSON(data []byte) error {
	var valueString string
	if err := json.Unmarshal(data, &valueString); err == nil {
		o.String = valueString
		return nil
...
func (o OpenApiEnumPropertyRequestEnumItem) MarshalJSON() ([]byte, error) {
	if o.String != "" {
		return json.Marshal(o.String)
	}
	if o.Integer != 0 {
...
type OpenApiEnumPropertyRequestEnumItemVisitor interface {
	VisitString(string) error
	VisitInteger(int) error
}

func (o *OpenApiEnumPropertyRequestEnumItem) Accept(visitor OpenApiEnumPropertyRequestEnumItemVisitor) error {
	if o.String != "" {
		return visitor.VisitString(o.String)
	}
	if o.Integer != 0 {
...
type OpenApiProperty struct {
	...
	OpenApiEnumProperty    *OpenApiEnumProperty
}
...
func (o *OpenApiProperty) UnmarshalJSON(data []byte) error {
	...
	valueOpenApiEnumProperty := new(OpenApiEnumProperty)
	if err := json.Unmarshal(data, &valueOpenApiEnumProperty); err == nil {
		o.OpenApiEnumProperty = valueOpenApiEnumProperty
		return nil
	}
	return fmt.Errorf("%s cannot be deserialized as a %T", data, o)
}
...
func (o OpenApiProperty) MarshalJSON() ([]byte, error) {
	...
	if o.OpenApiEnumProperty != nil {
		return json.Marshal(o.OpenApiEnumProperty)
	}
	return nil, fmt.Errorf("type %T does not include a non-empty union type", o)
}
...
type OpenApiPropertyVisitor interface {
	...
	VisitOpenApiEnumProperty(*OpenApiEnumProperty) error
}
...
func (o *OpenApiProperty) Accept(visitor OpenApiPropertyVisitor) error {
	...
	if o.OpenApiEnumProperty != nil {
		return visitor.VisitOpenApiEnumProperty(o.OpenApiEnumProperty)
	}
	return fmt.Errorf("type %T does not include a non-empty union type", o)
}
...
type OpenApiPropertyRequest struct {
	...
	OpenApiEnumPropertyRequest    *OpenApiEnumPropertyRequest
}
...
func (o *OpenApiPropertyRequest) UnmarshalJSON(data []byte) error {
	...
	valueOpenApiEnumPropertyRequest := new(OpenApiEnumPropertyRequest)
	if err := json.Unmarshal(data, &valueOpenApiEnumPropertyRequest); err == nil {
		o.OpenApiEnumPropertyRequest = valueOpenApiEnumPropertyRequest
		return nil
	}
	return fmt.Errorf("%s cannot be deserialized as a %T", data, o)
}
...
func (o OpenApiPropertyRequest) MarshalJSON() ([]byte, error) {
	...
	if o.OpenApiEnumPropertyRequest != nil {
		return json.Marshal(o.OpenApiEnumPropertyRequest)
	}
	return nil, fmt.Errorf("type %T does not include a non-empty union type", o)
}
...
type OpenApiPropertyRequestVisitor interface {
	...
	VisitOpenApiEnumPropertyRequest(*OpenApiEnumPropertyRequest) error
}
...
func (o *OpenApiPropertyRequest) Accept(visitor OpenApiPropertyRequestVisitor) error {
	...
	if o.OpenApiEnumPropertyRequest != nil {
		return visitor.VisitOpenApiEnumPropertyRequest(o.OpenApiEnumPropertyRequest)
	}
	return fmt.Errorf("type %T does not include a non-empty union type", o)
}
