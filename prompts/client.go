...
func (c *Client) Push(
	ctx context.Context,
	request *vellumclientgo.PromptPush,
	opts ...option.RequestOption,
) (*vellumclientgo.PromptPushResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	endpointURL := baseURL + "/v1/prompts/push"
	...
	var response *vellumclientgo.PromptPushResponse
	if err := c.caller.Call(
		ctx,
		&core.CallParams{
			URL:             endpointURL,
